...
describe User do
  describe '#index' do
    ...
    before do
      @user = build(:user,nickname: "",email: "", password: "",password_confirmation: "",first_name: "",last_name: "",first_kana: "",last_kana: "",date: "")
    end
    ...
    it "is invalid without a password_confirmation although with a password" do
      ...
      user.valid? #validatesに引っかかるかどうか
      expect(user.errors[:password_confirmation]).to include("とPasswordの入力が一致しません", "を入力してください", "は不正な値です")
